import { makeTrip, deleteTrip, updateTrip, findTripByUserId, findTripByAirport, findTripById } from "../content/trip";
    ...
    if (!paramsId && !req.token.is_admin) {
        ...
        if (trips == false) {
            return res
                .status(404)
                .json({
                    msg: "404: Trips cannot be found for your airport."
                });
        }
        res.status(200).json(trips);
    } else {
